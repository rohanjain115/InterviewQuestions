...
// alternate positions
public class MergeListAlternate
{
    ...
    void merge(MergeListAlternate q)
    {
    ...
    {
        MergeListAlternate llist1 = new MergeListAlternate();
        MergeListAlternate llist2 = new MergeListAlternate();
        llist1.push(3);
        llist1.push(2);
        llist1.push(1);
